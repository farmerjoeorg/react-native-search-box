...
class Search extends PureComponent {
  constructor (props) {
    ...
    this.state = {
      ...
      expanded: props.defaultValue ? true : false,
    }
    ...
    this.inputFocusWidthAnimated = new Animated.Value(this.contentWidth)
  ...
  onLayout = event => {
    ...
    this.contentWidth = contentWidth - 20
        ...
        <View style={{position: 'relative'}}>
          ...
          <TouchableWithoutFeedback onPress={this.onFocus}>
            {this.props.iconSearch
              ? <Animated.View
                style={[styles.iconSearch, {left: 5}]}
              >
                {this.props.iconSearch}
              </Animated.View>
              : <Animated.Image
...
Search.defaultProps = {
  ...
  searchIconCollapsedMargin: 20,
  searchIconExpandedMargin: 15,
  placeholderCollapsedMargin: 20,
